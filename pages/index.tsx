    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-100 text-center px-4">
      <div className="flex flex-col items-center mb-6">
        <img
          ...
          alt="Logo"
          style={{ width: '400px', height: 'auto', marginBottom: '0.5rem', backgroundColor: '#f3f4f6',  }}
        />
        <h1 className="text-4xl md:text-6xl font-bold text-green-800">BanaYeni SanaEski</h1>
      </div>

      <p className="text-xl text-gray-700">
        Senin için eski olan bir başkasının işine yarayabilir!
      </p>
      <p className="mt-2 text-md text-gray-500 max-w-xl">
        Türkiye’nin sürdürülebilir online hurdalığına hoş geldiniz. Aradığımız parçayı
        bulmanıza veya elinizdekini satmanıza yardım ederek sürdürülebilir ekonomiye katkı sunuyoruz.
      </p>
      ...
      <div className="mt-8 flex gap-4 flex-wrap justify-center">
        ...
        <Link href="/login">
          <button className="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded-xl shadow-md">
            Giriş / Kayıt
          </button>
        </Link>
      </div>
